...
<form action="../00_uploadNew.php" method="post" enctype="multipart/form-data">
<table width="899" border="0" cellspacing="0" cellpadding="0">
  <tr>
    <td id="tablehader"><input type="file" name="file[]" id="file" multiple/>
    <input type="submit" name="submit" value="ЗАГРУЗИТЬ ФАЙЛЫ" />
    </td>
  </tr>
<tr>
  <td id="tablehader"></td>
